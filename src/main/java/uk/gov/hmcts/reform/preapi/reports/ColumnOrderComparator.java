...
public class ColumnOrderComparator implements Comparator<String> {
        ...
        public ColumnOrderComparator(List<String> columnOrder) {
            this.columnOrder = columnOrder.stream().map(item -> item.toLowerCase(Locale.UK)).toList();
        }

        @Override
        public int compare(String o1, String o2) {
            log.info("Comparing {} and {}", o1, o2);
            return columnOrder.indexOf(o1.toLowerCase()) - columnOrder.indexOf(o2.toLowerCase());
        }
