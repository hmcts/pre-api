...
@Service
public class MigrationTrackerServiceXML {

    private List<PassItem> migratedItems = new ArrayList<>();
    private List<FailedItemXML> failedItems = new ArrayList<>();
    private final CsvWriterService csvWriterService;

    public MigrationTrackerServiceXML(CsvWriterService csvWriterService) {
    ...
    public void addFailedItem(FailedItemXML item) {
    ...
    public void writeFailedItemsToCsv(String fileName) {
        ...
        for (FailedItemXML item : failedItems) {
            UnifiedArchiveData archiveItem = item.getArchiveItem();
