...
public class AdminRepository {
     ...
     * Case, Court) that could contain the UUID. If found in that table, it returns a string e.g. if found in the users table,
     * it will return "user". It will return the first match it finds.
