...
import uk.gov.hmcts.reform.preapi.mediakind.MediaKindService;
...
public class RecordingController {
    ...
    @GetMapping("/{recording_id}/play")
    public ResponseEntity<StreamingLinkResponse> getLink(@PathVariable(name = "recording_id") String recordingId) {
        String streamingLocatorName = mediaKindService.getStreamingLocatorName(recordingId);
        return new ResponseEntity<>(
            mediaKindService.getStreamingPathsForStreamingLocator(streamingLocatorName),
            HttpStatus.OK
        );
    }
}
