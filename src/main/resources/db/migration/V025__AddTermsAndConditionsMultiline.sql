...
'1. I have a legitimate need to use the PRE Service, and will only access recordings associated with media of cases where I have a business need to do so.'
