...
(gen_random_uuid(), 'CROWN', 'Wolverhampton Crown Court', '421'),
...
(gen_random_uuid(), 'CROWN', 'Preston Combined Court Centre (Sessions House Annex)', '448'),
...
(gen_random_uuid(), 'CROWN', 'Chichester Nightingale Crown Court', NULL),
(gen_random_uuid(), 'CROWN', 'Hove Trial Centre', '1602'),
(gen_random_uuid(), 'MAGISTRATE', 'Brighton Magistrates Court', '431'),
...
(gen_random_uuid(), 'CROWN', 'Southend Crown Court', '772'),
...
(gen_random_uuid(), 'CROWN', 'Newport (I.O.W.) Combined Court', '478'),
...
ON CASE
    ...
    WHEN c.location_code IN ( '417', '452', '455', '456', '463', '466', '421' ) THEN r.NAME = 'West Midlands (England)'
    ...
    WHEN c.location_code IN ( '401', '431', '1602', '434', '445', '474', '479', '447', '454', '465', '478' ) THEN r.NAME = 'South East (England)'
    WHEN c.location_code IN ( '406', '408', '424', '446', '458', '459', '477', '480' ) THEN r.NAME = 'South West (England)'
    ...
    WHEN c.location_code IN ( '410', '414', '426', '443', '450', '461', '473', '476', '765', '772' ) THEN r.NAME = 'East of England'
...
WHERE (c.location_code = '409' AND c.name = 'Burnley Combined Court Centre')
   ...
   OR c.location_code IN (
	...
	'430', '432', '434', '435', '436', '437', '439', '440',
