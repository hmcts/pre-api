...
class PreProcessorTest {
    ...
    void testInitialize() {
        ...
        verify(valueOperations, times(1)).set("court:Court 1", court.getId().toString());
        verify(valueOperations, times(1)).set("case:Case123", caseEntity.getId().toString());
        verify(valueOperations, times(1)).set("user:user@test.com", user.getId().toString());
