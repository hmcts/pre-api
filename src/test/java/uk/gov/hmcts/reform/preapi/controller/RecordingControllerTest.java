...
class RecordingControllerTest {
    ...
    void testGetRecordingIdSuccess() throws Exception {
        ...
        when(recordingService.findAll(any(), any(), any(), any(), any(), any())).thenReturn(new PageImpl<>(recordingDTOList));
    ...
    void testGetRecordingIdScheduledForSuccess() throws Exception {
        ...
        verify(recordingService, times(1))
            .findAll(isNull(), isNull(), isNull(), isNull(), eq(Optional.of(Timestamp.valueOf("2024-01-01 00:00:00"))), any());
    }
