        ...
        for user in source_user_data:
            ...
            if not check_existing_record(destination_cursor,'portal_access', 'user_id', user_id):
                ...
                batch_portal_user_data.append((
                    id, user_id, password, last_access,  invited_at, registered_at, terms_accepted_at, created_at, modified_at, created_by
                ))
            ...
            if batch_portal_user_data:
                destination_cursor.executemany(
                    ...
                    INSERT INTO public.portal_access
                        (id, user_id, password, last_access,  invited_at, registered_at, terms_accepted_at, created_at, modified_at)
